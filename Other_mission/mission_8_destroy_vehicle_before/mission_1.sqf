...
_arry_vehicle_convoy append car_enemy_mission_arry;

if!((hevy_enemy_vehicle_arry select 0) isEqualTo str objNull)then{

	_arry_vehicle_convoy append hevy_enemy_vehicle_arry;

};

//Vehicle
_Vehicle_name_arry = [];
_vehicle_convoy = selectRandom car_enemy_mission_arry;
...
{
	_unit = group(selectRandom(units(BMP_delivery_explousion))) createUnit [selectRandom inf_enemy_missions_arry, [0,0,0], [], 0, "FORM"];
	_unit moveInCargo BMP_delivery_explousion;
};

for "_i" from 0 to floor(BMP_delivery_explousion_2  emptyPositions "cargo") /2 do 
{
	_unit = group(selectRandom(units(BMP_delivery_explousion_2))) createUnit [selectRandom inf_enemy_missions_arry, [0,0,0], [], 0, "FORM"];
	_unit moveInCargo BMP_delivery_explousion_2;
};

for "_i" from 0 to floor(BMP_delivery_explousion_3  emptyPositions "cargo") /2 do 
{
	_unit = group(selectRandom(units(BMP_delivery_explousion_3))) createUnit [selectRandom inf_enemy_missions_arry, [0,0,0], [], 0, "FORM"];
	_unit moveInCargo BMP_delivery_explousion_3;
};

for "_i" from 0 to floor(BMP_delivery_explousion_4  emptyPositions "cargo") /2 do 
{
	_unit = group(selectRandom(units(BMP_delivery_explousion_4))) createUnit [selectRandom inf_enemy_missions_arry, [0,0,0], [], 0, "FORM"];
	_unit moveInCargo BMP_delivery_explousion_4;
};

for "_i" from 0 to floor(BMP_delivery_explousion_5  emptyPositions "cargo") /2 do 
{
	_unit = group(selectRandom(units(BMP_delivery_explousion_5))) createUnit [selectRandom inf_enemy_missions_arry, [0,0,0], [], 0, "FORM"];
	_unit moveInCargo BMP_delivery_explousion_5;
};

for "_i" from 0 to floor(BMP_delivery_explousion_6  emptyPositions "cargo") /2 do 
{
	_unit = group(selectRandom(units(BMP_delivery_explousion_6))) createUnit [selectRandom inf_enemy_missions_arry, [0,0,0], [], 0, "FORM"];
