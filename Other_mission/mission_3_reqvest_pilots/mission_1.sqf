...
sleep 3;
["Task_03", true, ["Уничтожить подбитый вертолет","Уничтожить подбитый вертолет","respawn_west"], getMarkerPos _Marker3, "ASSIGNED", 5, true, true, "destroy", true] call BIS_fnc_setTask;
//smoke
