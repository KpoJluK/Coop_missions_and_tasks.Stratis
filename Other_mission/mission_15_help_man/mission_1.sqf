...
// find all bilding
private _arry_bilding = nearestObjects [_pos_mission, ["house"], 1000];
...
_group_man_medic = createGroup [player_side, false];
...
["Task_15", true, ["Вам нужно доставить медика к раненому","Доставить медика к персоне","respawn_west"], getPos _unit, "CREATED", 5, true, true, "heal", true] call BIS_fnc_setTask;
